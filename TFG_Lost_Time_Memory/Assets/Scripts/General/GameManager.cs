        ...
        if (started == 0)
        {
            ...
            for (int i = 0; i < 18; i++)
            {
                if(i<6)
                {
                    ...
                    allEnemies.Add(new Character.Info(i, -1, false, new List<Gear.Info>() { gi, gi, gi, gi, gi, gi }, 1, new Character.Stats()));
                }
                else if((i > 5) && (i < 12))
                {
                ...
                allChar.Add(new Character.Info(i, -1, false, new List<Gear.Info>() { gi, gi, gi, gi, gi, gi }, 1, new Character.Stats()));
            }
